...
<table style="width:100%">
    ...
    <tr>
        <td>gjm8_play</td>
        <td>带有播放按钮覆盖层的 gjm8 模板。用于生成链接到实际动画的截图。
        </td>
        <td>
            <table>
                <tr style="border-bottom: 1px solid white;">
    ...
    <tr>
        ...
        <td>基于 <a href="https://ethanschoonover.com/solarized/">solarized</a> 深色方案的基本模板
        </td>
        <td>
            <table>
                <tr style="border-bottom: 1px solid white;">
    ...
    <tr>
        ...
        <td>基于 <a href="https://ethanschoonover.com/solarized/">solarized</a> 浅色方案的基本模板
        </td>
        <td>
            <table>
                <tr style="border-bottom: 1px solid white;">
    ...
    <tr>
        <td>terminal_app</td>
        <td>基于 Terminal.app 默认颜色的基本模板</td>
        <td>
            <table>
                <tr style="border-bottom: 1px solid white;">
                    <td style="background:#000000"></td>
