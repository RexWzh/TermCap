...
See [here](../templates.md) for a gallery of the templates
...
<svg id="terminal" baseProfile="full" viewBox="0 0 656 325" width="656" version="1.1"
    ...
    <defs>
        <termcap:template_settings xmlns:termcap="https://github.com/rexwzh/termcap">
...
I hope that the information provided here together with the [code for the default templates](https://github.com/rexwzh/termcap/blob/master/src/termcap/data/templates) is enough to get started
...
When set to use CSS animations, termcap also defines a single CSS animation for the element
